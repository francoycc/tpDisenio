...
public class Objetos{
    ...
    //VEHICULOS
    public static Vehiculo VEHICULO1 = new Vehiculo(1780000, "AKSBJHFOAISFU", "9BWFA18U61M200000", "OBG182", MODELO_GOL_TREND, KM0_5000, LOCALIDAD1);
    public static Vehiculo VEHICULO2 = new Vehiculo(2506000,"POIEHKASNDF","9CDGA11U65X600000","AB322CC", MODELO_PRISMA , KM10000_30000, LOCALIDAD2);
    public static Vehiculo VEHICULO3 = new Vehiculo(1800000, "JWENPAKND", "1CDGB32C65X550000", "LHI992", MODELO_DUSTER, KM5000_10000, LOCALIDAD3);
    public static Vehiculo VEHICULO4 = new Vehiculo(1020100, "QPOJNLAKSDD", "9CDSC11B15X620000", "OAC157", MODELO_CELTA, KM30000_INF, LOCALIDAD4);
    public static Vehiculo VEHICULO5 = new Vehiculo(2300000, "PIJLEASND", "3XCFA45V61M200000", "OQP336", MODELO_ETIOS, KM30000_INF, LOCALIDAD1);
    public static Vehiculo VEHICULO6 = new Vehiculo(1890000, "APWENMASND", "8NMKA78U91N500000", "KKA890", MODELO_C4, KM30000_INF, LOCALIDAD2);
    public static Vehiculo VEHICULO71 = new Vehiculo(3300000,"PPPPSCLAKNS","9VVAD19U21M550000","AA156VV", MODELO_C4 , KM10000_30000, LOCALIDAD3);
    public static Vehiculo VEHICULO72 = new Vehiculo(2100000,"OQUESADNAS","9CLPO26I39A530000","AA246CB", MODELO_CLIO , KM10000_30000, LOCALIDAD4);
    public static Vehiculo VEHICULO8 = new Vehiculo(2650000, "PWOELASDN", "6VWAE19C55A150000", "PRC153", MODELO_CORSA, KM0_5000, LOCALIDAD1);
    public static Vehiculo VEHICULO9 = new Vehiculo(2650000, "QWJENKMASDBN", "IUDAISBDY55A150000", "12PXC13", MODELO_CORSA, KM10000_30000, LOCALIDAD1);
    //CLIENTES
