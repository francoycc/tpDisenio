...
public class Objetos{
    ...
    public static Direccion getDireccion8(){
        ...
        public static Vehiculo getVehiculo1(){
            ...
            anios1.add(anio1);
            Modelo modelo1 = new Modelo(15, "Gol Trend", new Marca(11,"Volkswagen"), Objetos.getHistorial(), anios1);
            Vehiculo vehiculo1 = new Vehiculo(12,1780000,"1.8L","9BWFA18U61M200000","OBG182", modelo1 ,new KmPorAnio(17000.0f, Objetos.getHistorial()), Objetos.getDireccion1());
            return vehiculo1;
        }
    ...
    public static Poliza getPoliza1(){
        MedidaDeSeguridad medida11 = new MedidaDeSeguridad(122,"Alarma", Objetos.getHistorial());
        MedidaDeSeguridad medida12 = new MedidaDeSeguridad(123,"Garage", Objetos.getHistorial());
        ...
        Poliza poliza1 = new Poliza(new Date(2023, Calendar.OCTOBER,2),new Date(2024, Calendar.APRIL,2), new Date(2011, Calendar.OCTOBER,10),
                FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_500, new DerechoEmision(15,Objetos.getHistorial()), new Descuento(15454,"Semestral", Objetos.getHistorial()), new TipoCobertura("Responsabilidad Civil"),
                cuotas1, medidas1, Objetos.getVehiculo1(), declaracionHijos1, Objetos.getCliente1(), new NumeroSiniestros(15635,2, Objetos.getHistorial()));
        return poliza1;
    }
    ...
    public static Vehiculo getVehiculo2() {
        ...
        anios2.add(anio21);
        anios2.add(anio22);
        Modelo modelo2 = new Modelo(16, "Prisma", new Marca(10,"Chevrolet"), Objetos.getHistorial(),anios2);
        Vehiculo vehiculo2 = new Vehiculo(13,2506000,"1.4L","9CDGA11U65X600000","AB322CC", modelo2 ,new KmPorAnio(25000.0f, Objetos.getHistorial()), Objetos.getDireccion2());
        return vehiculo2;
    }
...
public static Vehiculo getVehiculo3() {
    ...
    anios3.add(anio3);
    Modelo modelo3 = new Modelo(19, "Duster", new Marca(10,"Renault"), Objetos.getHistorial(), anios3);
    Vehiculo vehiculo3 = new Vehiculo(14,1800000,"1.4L","1CDGB32C65X550000","LHI992", modelo3 ,new KmPorAnio(80000.0f, Objetos.getHistorial()), Objetos.getDireccion3());
    return vehiculo3;
}
...
public static Poliza getPoliza2() {
    ...
    Poliza poliza2 = new Poliza(new Date(2023, Calendar.SEPTEMBER,11),new Date(2024, Calendar.MARCH,15), new Date(2011, Calendar.OCTOBER,10),
            FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_5000, new DerechoEmision(162, Objetos.getHistorial()), new Descuento(15462,"Semestral", Objetos.getHistorial()), new TipoCobertura("Terceros Completos"),
            cuotas2, medidas2, Objetos.getVehiculo3(), declaracionHijos2, Objetos.getCliente3(), new NumeroSiniestros(15622,0, Objetos.getHistorial()));
    return poliza2;
}
...
public static Vehiculo getVehiculo4() {
    ...
    anios4.add(anio42);
    anios4.add(anio43);
    Modelo modelo4 = new Modelo(18, "Celta", new Marca(11, "Chevrolet"), Objetos.getHistorial(), anios4);
    Vehiculo vehiculo4 = new Vehiculo(10, 1020100, "1.2L", "9CDSC11B15X620000", "OAC157", modelo4, new KmPorAnio(30000.0f, Objetos.getHistorial()), Objetos.getDireccion4());
    return vehiculo4;
}
public static Cliente getCliente4(){
        ...
        public static Poliza getPoliza3() {
            ...
            Poliza poliza3 = new Poliza(new Date(2023, Calendar.JUNE,11),new Date(2023, Calendar.NOVEMBER,15), new Date(2015, Calendar.OCTOBER,23),
                    FormaPago.MENSUAL, EstadoPoliza.SUSPENDIDA, 1_500,new DerechoEmision(95,Objetos.getHistorial()), null , new TipoCobertura("Todo Total"),
                    cuotas3, medidas3, Objetos.getVehiculo4(),null, Objetos.getCliente4(), new NumeroSiniestros(15326,10, Objetos.getHistorial()));
            return poliza3;
        }
        ...
        public static Vehiculo getVehiculo5() {
            ...
            anios5.add(anio5);
            Modelo modelo5 = new Modelo(20, "Etios", new Marca(215,"Toyota"), Objetos.getHistorial(),anios5);
            Vehiculo vehiculo5 = new Vehiculo(21,2300000,"1.6L","3XCFA45V61M200000","OQP336", modelo5 ,new KmPorAnio(21000.0f, Objetos.getHistorial()), Objetos.getDireccion5());
            return vehiculo5;
        }
...
public static Poliza getPoliza4() {
    ...
    Poliza poliza4 = new Poliza(new Date(2022, Calendar.SEPTEMBER,11),new Date(2023, Calendar.FEBRUARY,10), new Date(2015, Calendar.DECEMBER,3),
            FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_500, new DerechoEmision(988, Objetos.getHistorial()), new Descuento(784, "Semestral", Objetos.getHistorial()), new TipoCobertura("Todo Riesgo con Franquicia"),
            cuotas4, medidas4, Objetos.getVehiculo5(), declaracionHijos4, Objetos.getCliente5(), new NumeroSiniestros(15645,1, Objetos.getHistorial()));
    return poliza4;
        }
        public static Vehiculo getVehiculo6(){
            ...
            anios6.add(anio6);
            Modelo modelo6 = new Modelo(21, "C4", new Marca(315,"Citroen"), Objetos.getHistorial(), anios6);
            Vehiculo vehiculo6 = new Vehiculo(22,1890000,"1.6L","8NMKA78U91N500000","KKA890", modelo6 ,new KmPorAnio(30000.0f, Objetos.getHistorial()), Objetos.getDireccion6());
            return vehiculo6;
        }
...
public static Poliza getPoliza5() {
    ...
    Poliza poliza5 = new Poliza(new Date(2023, Calendar.OCTOBER,26),new Date(2024, Calendar.APRIL,26), new Date(2011, Calendar.OCTOBER,25),
            FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 2_500, new DerechoEmision(15431, Objetos.getHistorial()), new Descuento(15454,"Semestral", Objetos.getHistorial()), new TipoCobertura("Responsabilidad Civil"),
            cuotas5, medidas5, Objetos.getVehiculo6(), declaracionHijos5, Objetos.getCliente6(), new NumeroSiniestros(13437,6, Objetos.getHistorial()));
    ...
    public static Vehiculo getVehiculo71() {
        ...
        AnioFabricacion anio71 = new AnioFabricacion(9,2020);
        anios71.add(anio71);
        Modelo modelo71 = new Modelo(26, "C4", new Marca(19,"Citroen"), Objetos.getHistorial(), anios71);
        Vehiculo vehiculo71 = new Vehiculo(19,3300000,"1.8L","9VVAD19U21M550000","AA156VV", modelo71 ,new KmPorAnio(26000.0f, Objetos.getHistorial()), Objetos.getDireccion7());
        return vehiculo71;
    }

    public static Vehiculo getVehiculo72() {
        List<AnioFabricacion> anios72 = new ArrayList<>();
        AnioFabricacion anio72a = new AnioFabricacion(12,2020);
        AnioFabricacion anio72b = new AnioFabricacion(15,2018);
        anios72.add(anio72a);
        anios72.add(anio72b);
        Modelo modelo72 = new Modelo(35, "Clio", new Marca(293,"Renault"), Objetos.getHistorial(), anios72);
        Vehiculo vehiculo72 = new Vehiculo(293,2100000,"1.4L","9CLPO26I39A530000","AA246CB", modelo72 ,new KmPorAnio(15000.0f, Objetos.getHistorial()), Objetos.getDireccion7());
        return vehiculo72;
    }
...
public static Poliza getPoliza61() {
    MedidaDeSeguridad medida61a = new MedidaDeSeguridad(132,"Alarma", new HistorialFactor());
    MedidaDeSeguridad medida61b = new MedidaDeSeguridad(135,"Garage", new HistorialFactor());
    ...
    Poliza poliza61 = new Poliza(new Date(2023, Calendar.MARCH,2),new Date(2024, Calendar.SEPTEMBER,10), new Date(2017, Calendar.OCTOBER,16),
            FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_700, new DerechoEmision(2152, Objetos.getHistorial()), new Descuento(12431,"Doble Unidad", Objetos.getHistorial()), new TipoCobertura("Responsabilidad Civil"),
            cuotas61, medidas61, Objetos.getVehiculo71(),null, Objetos.getCliente7(), new NumeroSiniestros(15641,1, Objetos.getHistorial()));
        return poliza61;
        }

    public static Poliza getPoliza62() {
        MedidaDeSeguridad medida62a = new MedidaDeSeguridad(137,"Alarma", new HistorialFactor());
        MedidaDeSeguridad medida62b = new MedidaDeSeguridad(321,"Garage", new HistorialFactor());
        ...
        Poliza poliza62 = new Poliza(new Date(2023, Calendar.MARCH,2),new Date(2024, Calendar.SEPTEMBER,10), new Date(2017, Calendar.OCTOBER,16),
                FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_600, new DerechoEmision(2153, Objetos.getHistorial()), new Descuento(12432,"Doble Unidad", Objetos.getHistorial()), new TipoCobertura("Responsabilidad Civil"),
                cuotas62, medidas62, Objetos.getVehiculo71(), null, Objetos.getCliente7(), new NumeroSiniestros(15642,3, Objetos.getHistorial()));
        return poliza62;
    }
    ...
    public static Vehiculo getVehiculo8() {
        ...
        anios8.add(anio8);
        Modelo modelo8 = new Modelo(28, "Corsa", new Marca(19,"Chevrolet"), Objetos.getHistorial(),anios8);
        Vehiculo vehiculo8 = new Vehiculo(25,2650000,"1.4L","6VWAE19C55A150000","PRC153", modelo8 ,new KmPorAnio(21000.0f, Objetos.getHistorial()), Objetos.getDireccion8());
        return vehiculo8;
        }
    ...
    public static Cliente getCliente8() {
        ...
        public static Poliza getPoliza7() {
            ...
            Poliza poliza7 = new Poliza(new Date(2023, Calendar.JANUARY,12),new Date(2024, Calendar.JULY,15), new Date(2019, Calendar.OCTOBER,16),
                    FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_500, new DerechoEmision(2225, Objetos.getHistorial()), new Descuento(12652,"Semestral", Objetos.getHistorial()), new TipoCobertura("Terceros Completo"),
                    cuotas7, medidas7, Objetos.getVehiculo8() ,null , Objetos.getCliente8(), new NumeroSiniestros(15642,2, Objetos.getHistorial()));
            return poliza7;
        }
        ...
        public static Poliza getPoliza8() {
            ...
            Poliza poliza8 = new Poliza(new Date(2022, Calendar.AUGUST,11),new Date(2023, Calendar.JANUARY,14), new Date(2019, Calendar.OCTOBER,16),
                    FormaPago.SEMESTRAL, EstadoPoliza.VIGENTE, 1_600, new DerechoEmision(2239, Objetos.getHistorial()), new Descuento(15263,"Semestral", Objetos.getHistorial()), new TipoCobertura("Terceros Completo"),
                    cuotas8, medidas8, Objetos.getVehiculo8(),null , Objetos.getCliente8(), new NumeroSiniestros(15643,1, Objetos.getHistorial()));
            return poliza8;
        }
}
